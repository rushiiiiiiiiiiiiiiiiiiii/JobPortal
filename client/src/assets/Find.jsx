...
const Find = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://jobportal-server-fwl8.onrender.com/${uid}`)
      .then((res) => {
  ...
  const toggleLike = (jobid, action) => {
    axios
      .post("https://jobportal-server-fwl8.onrender.com/joblike", { uid, jobid })
      .then(() => {
        setLikedJobs((prev) => ({
          ...prev,
          [jobid]: action === "like",
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://jobportal-server-fwl8.onrender.com/getlikedjobs/${uid}`)
      .then((res) => {
              ...
              .map((job, index) => (
                ...
                >
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <img
                      src={`https://jobportal-server-fwl8.onrender.com/${job.image}`}
                      alt={`${job.cname} Logo`}
