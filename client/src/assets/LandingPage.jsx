...
const LandingPage = () => {
  ...
  return (
    <Layout>
      <div className="bg-gradient-to-br from-blue-50 via-white to-gray-100 text-gray-900 min-h-screen font-sans">
        {/* Hero Section */}
        <div className="text-center bg-gradient-to-b from-blue-500 via-blue-700 to-blue-900 text-white px-4 sm:px-8 py-20">
          ...
          <div className="flex justify-center flex-wrap gap-4 mb-12">
            <Link to="/home2">
              <button className="bg-yellow-400 hover:bg-yellow-500 text-gray-900 px-6 py-3 rounded-lg shadow-lg transition duration-200">
                Find Jobs
              </button>
            </Link>
            <Link to="/home2">
              <button className="bg-red-400 hover:bg-red-500 text-gray-900 px-6 py-3 rounded-lg shadow-lg transition duration-200">
                Post a Job
              </button>
            </Link>
          </div>
        ...
        <div className="mt-6 max-w-6xl mx-auto px-4">
          <h2 className="text-3xl sm:text-4xl font-bold mb-8 text-center text-gray-800">What And Who We Help?</h2>

          <img
            src="/images/image_1737111507864"
            alt="Banner"
            className="w-full h-auto rounded-lg shadow-xl transform transition-all duration-300 "
          />
          <div className="flex gap-14">
            <div className="mt-8 w-[48%] bg-gray-100 p-6 rounded-lg hover:scale-105 transform transition-all duration-300">
              <h3 className="text-2xl font-semibold mb-2 text-center text-gray-800">For Job Seekers</h3>
              <p className="text-center text-gray-700">Search and apply for jobs, track applications, and more.</p>
            </div>
            <div className="mt-8 w-[48%] bg-gray-100 p-6 rounded-lg hover:scale-105 transform transition-all duration-300">
              <h3 className="text-2xl font-semibold mb-2 text-center text-gray-800">For Employers</h3>
              <p className="text-center text-gray-700">Post jobs, manage applications, and find the best candidates.</p>
            </div>
          </div>
        </div>

        {/* FAQ Section */}
        <div className="h-auto w-full bg-gradient-to-b from-gray-100 to-gray-300">
          <div className="mt-16 px-6 sm:px-12 max-w-5xl mx-auto mb-20">
            <h2 className="text-center text-2xl sm:text-3xl font-bold pt-10 mb-8 text-gray-800">Frequently Asked Questions</h2>
            <div className="space-y-4 pt-4">
              {faqs.map((faq, index) => (
                <div
                  key={index}
                  className="border border-gray-300 rounded-lg p-4 cursor-pointer bg-white hover:bg-gray-200 transition duration-200"
                ...
                >
                  ...
                  {activeFAQ === index && (
                    <p className="mt-2 text-gray-600 transition-opacity duration-500">{faq.answer}</p>
                  )}
                </div>
              ))}
            </div>
        ...
        <div className="h-auto w-full bg-gradient-to-b from-white to-gray-200">
          <div className="mt-2 max-w-6xl mx-auto px-4">
            <div className="bg-white text-gray-900 p-8 rounded-lg shadow-lg">
              ...
              <div className="flex justify-center mb-6">
                <Link to="/start">
                  <button className="bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-medium shadow-lg transition duration-200">
                    Get Started
                  </button>
                </Link>
              </div>
              ...
              <div className="bg-gray-100 p-6 rounded-lg mt-6">
                <h3 className="text-2xl font-semibold mb-4 text-center text-gray-800">How It Works</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="flex items-center space-x-4">
                    ...
                    <p className="text-gray-800 text-lg font-medium">Step 1: Add Your Details</p>
                  </div>
                  <div className="flex items-center space-x-4">
                    <div className="bg-blue-500 p-4 rounded-full shadow-lg">
                      <svg
                    ...
                    <p className="text-gray-800 text-lg font-medium">Step 2: Select a Template</p>
                  </div>
                  <div className="flex items-center space-x-4">
                    <div className="bg-blue-500 p-4 rounded-full shadow-lg">
                      <svg
                    ...
                    <p className="text-gray-800 text-lg font-medium">Step 3: Download & Share</p>
                  </div>
                </div>
              </div>

              {/* Additional Features Section */}
              <div className="mt-8 mb-5 bg-gray-100 p-6 rounded-lg">
                <h3 className="text-2xl font-semibold mb-4 text-center text-gray-800">Additional Features</h3>
