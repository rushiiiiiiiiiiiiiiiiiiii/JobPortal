...
const RecruJdetail = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://https://jobportal-server-fwl8.onrender.com/getapplied/${jid}`)
      .then((res) =>{ 
  ...
  useEffect(() => {
    axios
      .get(`https://jobportal-server-fwl8.onrender.com/getuser/${uid}`)
  ...
  useEffect(() => {
    axios
      .get(`https://jobportal-server-fwl8.onrender.com/getalluser`)
      .then((res) => {
        // console.log(res.data)
  ...
  useEffect(() => {
    axios
      .get(`https://jobportal-server-fwl8.onrender.com/showjobinfo/${jid}`)
  ...
  useEffect(() => {
    axios
      .get("https://jobportal-server-fwl8.onrender.com/showjob")
  ...
  const send = async (jobid) => {
    try {
      await axios.post("https://jobportal-server-fwl8.onrender.com/jobapplay", { uid, jobid });
      const res = await axios.get(`https://jobportal-server-fwl8.onrender.com/getapplied/${jid}`);
      setApplaydata(res.data || []);
    ...
    <Layout>
      <div className="min-h-screen bg-gray-900 text-white font-sans">
        ...
        <div className="flex justify-between">
            ...
            {jobdata?.image && (
              <img
                src={`https://jobportal-server-fwl8.onrender.com/${jobdata.image}`}
                alt="Company Logo"
